unit SESNumberBox;
{ ----------------------------------------------------------
  Number box with units component (c) J. Dempster 1999-2020
  ----------------------------------------------------------
...
type
  TSESNumberBox = class(TCustomEdit)
  private
...
procedure Register;
begin
  RegisterComponents('Samples', [TSESNumberBox]);
end;


constructor TSESNumberBox.Create(AOwner : TComponent) ;
{ --------------------------------------------------
...
procedure TSESNumberBox.SetValue(
          Value : single
          ) ;
{ -----------------------------------------------
...
function TSESNumberBox.GetValue : single ;
{ -----------------------------------------------
...
procedure TSESNumberBox.SetScale(
          Value : single
          ) ;
{ --------------------------------------------
...
procedure TSESNumberBox.SetUnits(
          Value : string
          ) ;
{ -------------------------------------------------
...
procedure TSESNumberBox.SetFormatString(
          Value : string
          ) ;
{ -------------------------------------------------
  Set the units of the value stored in the edit box
...
procedure TSESNumberBox.SetMin(
          Value : Single
          ) ;
{ -------------------------------------------------
...
procedure TSESNumberBox.SetMax(
          Value : Single
          ) ;
{ -------------------------------------------------
...
procedure TSESNumberBox.UpdateEditBox ;
{ ------------------------------------
...
//procedure TSESNumberBox.OnTyping
//begin
...
procedure TSESNumberBox.ReadEditBox ;
{ -----------------------------------------------
...
function TSESNumberBox.LimitTo(
...
procedure TSESNumberBox.ExtractFloat (
